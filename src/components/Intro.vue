<template>
  ...
  <header class="flex justify-between px-11 py-6 z-0 transition-all delay-200 items-center max-lg:px-5 max-lg:transition-all">
    ...
    <a :class="active ? 'mr-[-50%]' : 'mr-12'" class="block" href="#">
    ...
    <div class="grid grid-flow-col items-center justify-items-center h-[85vh] mx-[10%] 
      ...
      <div class="flex flex-col items-start mr-auto place-self-center 
        ...
        <div class="flex flex-wrap mt-20 place-self-stretch justify-between items-center 
          ...
          <img class="w-[20%] min-w-[64px]" src="../../images/client-databiz.svg">
          <img class="w-[20%] min-w-[64px]" src="../../images/client-audiophile.svg">
          <img class="w-[20%] min-w-[64px]" src="../../images/client-meet.svg">
          <img class="w-[20%] min-w-[64px]" src="../../images/client-maker.svg">
