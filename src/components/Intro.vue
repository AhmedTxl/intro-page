<template>
  ...
  <header class="flex justify-between px-11 py-6 z-0 items-center">
    <div class="block sm:hidden">
      <button @click="toggle" class="flex items-center px-3 py-2 rounded-lg hover:brightness-0">
    ...
    <nav :class="active ? 'flex flex-col' : 'hidden'" 
      ...
      <Menu as="div" class="relative inline-block text-left">
        <div>
          <MenuButton @click="toggleArrow($event)" class="transition ease-in-out duration-300 flex items-center 
                                    no-underline text-[15px] gap-1 mt-4 sm:mt-0 text-gray-500 hover:text-black 
                                    hover:brightness-0 mr-2">
            Company
      ...
      <a href="#" class="transition ease-in-out duration-300 no-underline 
                                  block mt-4 text-[15px] sm:inline-block sm:mt-0 text-gray-500 hover:text-black mr-4">
        Careers
      </a>
      <div class=" contents">
        <a href="#" class="transition ease-in-out duration-300 no-underline 
  ...
  <main>
    <div class="flex flex-row max-w-screen-xl py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
      <div class="mr-auto mt-24 place-self-center text-left md:order-[-1] lg:col-span-7 max-w-[32.5em]">
        ...
        <p class="max-w-2xl mb-6 font-medium text-gray-500 lg:mb-8 md:text-lg lg:text-[18px]">
        ...
        <div class="flex flex-wrap justify-center items-center mt-[14.5vh] sm:justify-around">
          <a href="#" class="cursor-default mr-1 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
          ...
          <a href="#" class="cursor-default mr-1 mb-5 lg:mb-0 hover:text-gray-800">
      ...
      <img class="max-w-[466px] md:order-1" src="../../images/image-hero-desktop.png" alt="Landing Main Image">
    </div>
  </main>
